  ...
  return (
    <section className="h-full w-full rounded-2xl bg-green-50 p-4">
      <div className="flex justify-between">
        <div className="flex flex-row gap-4">
          <div className="relative h-12 w-12">
            <Image src={endan} height={48} width={48} alt="..." className=" rounded-full"></Image>
          </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <button className="bg-white rounded-xl h-12">Sign In</button>
        <button className="bg-white rounded-xl h-12">Sign Up</button>
